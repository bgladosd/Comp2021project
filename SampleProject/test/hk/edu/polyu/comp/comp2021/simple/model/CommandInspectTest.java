...
public class CommandInspectTest {
    ...
    public void testConstructorExecute () {
        ...
        Command c1 = new CommandInspect("inspect program2 y".split(" "), m);
        String printString = "program name is not correct it should be program1";
    ...
    public void testConstructorExecute2 () {
        m.setRunningProgramName("program1");
        Command c1 = new CommandInspect("inspect program1 y".split(" "), m);
        String printString = "inspect can't find the variable with var name : y";
        assertEquals(printString ,outContent.toString().trim());
    }
